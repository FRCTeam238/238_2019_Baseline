...
public final class CrusaderCommon {
    ...
    public final static double SHOULDER_KP = 0.05; // .025
    ...
    public static final double TEST_DRIVETRAIN_TOLERANCE = 0.25 * TEST_DRIVETRAIN_BASELINE; // limit between expected
                                                                                            // and actual encoder values
    ...
    public static class ScoringPositions {
        ...
        // public static final double ROCKET_CARGO_LEVEL_ONE_SHOULDER = 79;//76
        // //50;//60;
