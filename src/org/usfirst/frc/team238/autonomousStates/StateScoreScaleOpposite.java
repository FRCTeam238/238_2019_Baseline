...
public class StateScoreScaleOpposite implements AutonomousState {

  CommandRunTrajectory leftScaleOpp;
  CommandRunTrajectory rightScaleOpp;
  
  String       parameters[];
  boolean 		rightside;
  public void init(String params[], CommandController theMcp) {
	  
      leftScaleOpp = (CommandRunTrajectory) theMcp.getAutoCmd("CommandRunScaleLeftOppositeSideTrajectory");
      rightScaleOpp = (CommandRunTrajectory) theMcp.getAutoCmd("CommandRunScaleRightOppositeSideTrajectory");
      parameters = params;
  ...
  public void prepare() {
      ...
      if(gameData.length() > 0)
      {
		    ...
		    {
		    	rightside = false;
		    	leftScaleOpp.setParams(parameters);
		        leftScaleOpp.prepare();
		    }
		    else
		    {
		    	rightside = true;
		    	rightScaleOpp.setParams(parameters);
		        rightScaleOpp.prepare();
		    }
