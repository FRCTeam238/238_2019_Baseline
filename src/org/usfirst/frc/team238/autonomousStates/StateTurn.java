...
public class StateTurn implements AutonomousState {

  CommandTurn  turnCommand;
  ...
  @Override
  public void prepare() {
    turnCommand.setParams(parameters);
    turnCommand.prepare();
  ...
  public void init(String params[], CommandController theMcp) {
    ...
    turnCommand = (CommandTurn) theMcp.getAutoCmd("CommandTurn");
    parameters = params;
  ...
  @Override
  public void process() {
    Logger.Log("StateTurn.Process() "+ count);
    count++;
    turnCommand.execute();
  }
