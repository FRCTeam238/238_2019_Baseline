...
public class StateGoStraight implements AutonomousState {

  CommandRunTrajectory goStraight;
  String       parameters[];

  public void init(String params[], CommandController theMcp) {
      goStraight = (CommandRunTrajectory) theMcp.getAutoCmd("CommandRunGoStraightTrajectory");
      parameters = params;
  }
  ...
  public void process() {
      ...
      goStraight.execute();
      Logger.Log("StateGoStraight.Process()");
  }

  public boolean done() {
    if (goStraight.done() == true) 
    {
      return true;
    } 
    else 
  ...
  @Override
  public void prepare() {
      goStraight.setParams(parameters);
      goStraight.prepare();
  }
