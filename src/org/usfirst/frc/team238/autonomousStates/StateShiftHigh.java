...
public class StateShiftHigh implements AutonomousState {

  CommandShiftHigh shiftHighCommand;
  int                 count = 0;
  String              parameters[];

  @Override
  public void prepare() {
    shiftHighCommand.prepare();
  ...
  public void init(String params[], CommandController theMcp) {
    ...
    shiftHighCommand = (CommandShiftHigh) theMcp.getAutoCmd("CommandShiftHigh");
    parameters = params;
