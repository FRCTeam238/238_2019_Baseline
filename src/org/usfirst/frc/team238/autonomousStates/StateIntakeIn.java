...
public class StateIntakeIn implements AutonomousState
{
    CommandIntakeIn intakeInCommand;
    String parameters[];
    ...
    {
        // TODO Auto-generated method stub
        intakeInCommand = (CommandIntakeIn) theMcp.getAutoCmd("CommandIntakeIn");
    }
